      ...
      >
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="hidden items-center gap-3 lg:flex">
            ...
            <Link
              to="/register"
              className="rounded-lg bg-primary px-4 py-2 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-primary-light"
            >
              Register
            </Link>
          </div>
          ...
          <>
            ...
            >
              ...
              <Link
                to="/register"
                onClick={closeDrawer}
                className="flex items-center gap-3 px-5 py-3.5 text-left text-[15px] font-medium text-text-primary hover:bg-black/[0.03]"
              >
